...
./server_conf.rb : change all host info (to your current ip address)
...
12/1/2012: Chrome version under 23 is not guaranteed to work. Lower version of Chrome (at least v.18) is known to cause images not being stored correctly into the offline storage.
